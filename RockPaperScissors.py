...
winner_label = tkinter.Label(screen,fg="green")
winner_label.grid(row=2,column=3)
label2 = tkinter.Label(screen,fg="gray",text="Your Options:",font=(20))
label2.grid(row=2,column=1)

rock_button = tkinter.Button(screen,bg="red",text="Rock",fg="white",font=("bold"),command=game("rock"))
rock_button.grid(row=3,column=2)
paper_button = tkinter.Button(screen,bg="gray",text="Paper",fg="white",font=("bold"),command=game("paper"))
paper_button.grid(row=3,column=3)
scissors_button = tkinter.Button(screen,bg="blue",text="Scissors",fg="white",font=("bold"),command=game("scissors"))
